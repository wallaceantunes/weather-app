...
export const Home = () => {
    ...
    const citiesUrl = 'http://ibge.cplotter.com.br:3008/35'
    ...
    return weather && <>
        ...
        <ModalCenter showModal={showModalCenter} setShowModal={setShowModalCenter} ufs={ufs} cities={cities} />
